...
class _SeekerHomeScreenState extends ConsumerState<SeekerHomeScreen> {
                    ...
                    builder: (context, constraints) {
                      ...
                      final children = [
                        _QuickToolButton(
                          ...
                          onTap: () => _openTextRecognition(context),
                        ),
                        _QuickToolButton(
                          label: '颜色识别',
                          ...
                          semanticLabel: '颜色识别',
                          onTap: () => _openColorRecognition(context),
                        ),
                        _QuickToolButton(
                          label: 'AI 对话',
                          ...
                          semanticLabel: '智能对话',
                          onTap: () => _openDefaultAIChat(context),
                        ),
                      ];
  ...
  void _openTextRecognition(BuildContext context) {
    pushDemoStageRoute(
      context,
  ...
  void _openColorRecognition(BuildContext context) {
    pushDemoStageRoute(
      context,
      page: const DemoAIChatScreen(
        title: 'AI颜色识别',
  ...
  void _openDefaultAIChat(BuildContext context) {
    pushDemoStageRoute(
      context,
      page: const DemoAIChatScreen(
        title: 'AI智能对话',
