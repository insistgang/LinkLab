...
enum LinkableIconName {
  ...
  help('help', '帮助'),
  helpHistory('help_history', '我的求助历史'),
  ...
  personalProfile('personal_profile', '个人档案'),
  personalizedExperience('personalized_experience', '个性化使用体验'),
  photoHelp('photo_help', '拍照求助'),
  points('points', '积分'),
  processing('processing', '处理中'),
  profile('profile', '个人中心'),
  report('report', '举报'),
  safetyReady('safety_ready', '安全就绪度'),
  saveSettings('save_settings', '保存设置'),
  scan('scan', '扫一扫'),
  sceneDescribe('scene_describe', '场景描述'),
  screenReader('screen_reader', '读屏'),
  search('search', '搜索'),
  selectDisability('select_disability', '请选择你的障碍类型'),
  send('send', '发送'),
  settings('settings', '设置'),
  signLanguage('sign_language', '手语识别'),
  speechImpairment('speech_impairment', '言语障碍'),
  speechToText('speech_to_text', '语音转文字'),
  tempHelp('temp_help', '临时需要帮助'),
  textHelp('text_help', '文字求助'),
  translateRelay('translate_relay', '翻译代述'),
  tts('tts', '语音输出'),
  unknown('unknown', '不确定'),
  vibrationFlash('vibration_flash', '震动闪光提醒'),
  visualImpairment('visual_impairment', '视力障碍'),
  voiceCall('voice_call', '语音通话'),
  voiceHelp('voice_help', '语音求助'),
  voiceInput('voice_input', '语音输入'),
  volunteerMatch('volunteer_match', '志愿者匹配'),
  volunteerRole('volunteer_role', '我是志愿者'),
  wantToHelp('want_to_help', '我想帮助他人'),
  weather('weather', '天气'),
